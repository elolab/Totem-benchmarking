...
dynwrap_object <- readRDS("~/linear_tree/multifurcating_4.rds")
...
ReturnSmoothedTrajNetwork(sce,clustering.name = "7.234")

sce <- ChangeTrajRoot(sce,traj.name="7.234",root.cluster=2)
